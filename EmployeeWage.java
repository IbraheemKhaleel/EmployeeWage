...
public class EmployeeWage implements EmployeeWageInterface 
{
	...
	public void addCompany( String company , int wagePerHour , int maxWorkingHours, int maxWorkingDays)
	{
		...
		employeeWageBuilderMap.put(company, employeeWageBuilder);
	}
	...
	{
		return employeeWageBuilderMap.get(company).totalEmployeeWage;
	}
	...
	public static void main(String args[])
	{
		...
		System.out.println(" Total employee wage for Reliance is " + employeeWage.getTotalWage(" Reliance "));
	}
}
